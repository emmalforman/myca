    ...
    <div>
      ...
      <section className="relative">
        ...
        <div className="relative max-w-6xl mx-auto px-6 lg:px-8 py-28 sm:py-36 lg:py-44">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-serif text-cream leading-[1.1] mb-8 max-w-4xl">
            Where the future of
            <br />
            food gets built.
          </h1>
            ...
            {[
              ...
              <ScrollReveal key={item.title} delay={i * 150}>
                <div className="group p-8 bg-white border border-forest-100 hover:border-forest-300 transition-all h-full">
                  <svg
                    className="w-8 h-8 text-forest-400 mb-6"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  <h3 className="text-lg font-serif text-forest-900 mb-3">
                    {item.title}
                  </h3>
